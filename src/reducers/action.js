...
export const getOwners = (owners) => async(dispatch) =>{
    try {
        const res = await fetch("https://nodepriva.herokuapp.com/allowners",{
            method:"get",
...
export const setOwners = (value)=> async (dispatch) =>{
   ...
   try {
       const res = await fetch("https://nodepriva.herokuapp.com/setOwners",{
           method:"post",
           headers:{"content-type":"application/json"},
...
export const updateowners = (dataOwner )=> async (dispatch)=>{ 
    try {
        const res = await fetch(`https://nodepriva.herokuapp.com/update_owner`,{
            method:"post",
            headers:{"content-type":"application/json"},
